...
mv $RPM_BUILD_ROOT/usr/local/noobaa-core/src/deploy/standalone/logrotate_noobaa.conf $RPM_BUILD_ROOT/etc/logrotate.d/noobaa/logrotate_noobaa.conf
mv $RPM_BUILD_ROOT/usr/local/noobaa-core/src/deploy/standalone/logrotate_noobaa.sh $RPM_BUILD_ROOT/etc/logrotate.d/noobaa/logrotate_noobaa.sh
chmod +x $RPM_BUILD_ROOT/etc/logrotate.d/noobaa/logrotate_noobaa.sh

%files
/usr/local/noobaa-core
%{_unitdir}/noobaa.service
/etc/logrotate.d/noobaa/logrotate_noobaa.conf
/etc/logrotate.d/noobaa/logrotate_noobaa.sh
